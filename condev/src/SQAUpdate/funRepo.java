...
public class funRepo {
	...
	{ 
		...
		driver.findElement(By.xpath(".//*[@id='SitemapContent_dlSiteMap_HyperLink1_0']")).click();
	} 
    ...
    driver.findElement(By.xpath(P.getProperty("RTE"))).clear();
    driver.findElement(By.xpath(P.getProperty("RTE"))).sendKeys(Question);
     ...
     // driver.findElement(By.xpath(".//*[@id='MainContent_SQAEditor_QHTML_WebHtmlEditor1_tb_ctl04_image']")).click();
      ...
      driver.findElement(By.xpath(P.getProperty("RTE"))).clear();
      driver.findElement(By.xpath(P.getProperty("RTE"))).sendKeys(Answer); 
      
      for (String winHandle : driver.getWindowHandles()) {
          driver.switchTo().window(winHandle); // switch focus of WebDriver to the next found window handle (that's your newly opened window)
     } 
      
      Select oSelect = new Select(driver.findElement(By.id(P.getProperty("BloomLevel"))));
      switch(BloomLevel) {
      case "Remember" :
      ...
      Thread.sleep(5000);
      driver.findElement(By.id(P.getProperty("SaveQuestion"))).click();
      Thread.sleep(5000);
	...
	public void UploadImage(Properties P,WebDriver driver,String QuestionImage,int i) throws InterruptedException
	{
		Thread.sleep(5000);
		  ...
		  String text= driver.findElement(By.xpath(P.getProperty("RTE"))).getText();
		  ...
		  driver.findElement(By.xpath(P.getProperty("RTE"))).clear();
		  driver.findElement(By.xpath(P.getProperty("RTE"))).sendKeys(FinalQuestion);
